...
<div class="widget-container">
  <div class="options-panel">
    <div class="flex-left-item">
      <button
        on:click={onMotionChange}
        id="start-btn"
        class="neo-btn neo-btn-secondary neo-btn-secondary--default"
      >
        {buttonLabel}
      </button>
    </div>
  ...
  <div class="animation-panel">
    {#if inMotion}
      <div
        class="boxy"
        transition:fly={{ duration: speed, easing: easingFunc, x: 500 }}
      ></div>
    {/if}
  </div>
</div>
